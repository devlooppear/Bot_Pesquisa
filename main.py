...
# 9-Nessa parte, foram trocados os elementos com caracteres incalidos, como com acentuação, pelos mesmos, mas sem acentuação
for i in range(len(titulos)): 
    
    titulos[i] = unidecode.unidecode(titulos[i]) 
